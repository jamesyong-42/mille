...
//! boundary to prove the public surface is usable from outside fx-core.
//!
...
// shape is test-only — fx-core intentionally doesn't ship it because
...
fn macos_real_rename_end_to_end() {
    use fx_core::{Watcher, WatcherOptions};
